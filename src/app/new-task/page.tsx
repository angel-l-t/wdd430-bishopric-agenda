...
export default function NewTask() {
    ...
    function checkValue(data : FormData) {
        const radio = data.get("dateTime1");
        const selected = data.get("type");
        const selected2 = data.get("assignedTo");
        console.log(radio + " " + selected + " " + selected2);
    }
    ...
    return(
        <form className="flex flex-col p-6 border" action={checkValue}>
            ...
            <label htmlFor="dateTime1" className="mt-8 font-bold">Due Date</label>
            <select defaultValue={"No"} onChange={(e) => {toggle(e, setOPen3, "Yes")}} className="border mt-2" id="dateTime1" name="dateTime1">
